...
export const IconExpand = S('M14 4h6v6 M20 4l-7.5 7.5 M10 20H4v-6 M4 20l7.5-7.5');
export const IconZoomIn = S('M11 4.5a6.5 6.5 0 1 1 0 13 6.5 6.5 0 0 1 0-13z M15.8 15.8 20 20 M11 8.4v5.2 M8.4 11h5.2');
export const IconZoomOut = S('M11 4.5a6.5 6.5 0 1 1 0 13 6.5 6.5 0 0 1 0-13z M15.8 15.8 20 20 M8.4 11h5.2');
export const IconFit = S('M4 9V5a1 1 0 0 1 1-1h4 M15 4h4a1 1 0 0 1 1 1v4 M20 15v4a1 1 0 0 1-1 1h-4 M9 20H5a1 1 0 0 1-1-1v-4');
